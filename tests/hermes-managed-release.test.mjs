...
test("requires Brand Runtime v0.9.1 across release metadata", async () => {
  ...
  assert.equal(packageManifest.version, "0.9.1");
  assert.equal(packageLock.version, "0.9.1");
  assert.equal(packageLock.packages[""].version, "0.9.1");
  assert.equal(project.version.current, "0.9.1");
  assert.equal(portable.version, "0.9.1");
