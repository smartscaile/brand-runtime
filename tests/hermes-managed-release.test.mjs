...
test("requires Brand Runtime v0.7.0 across release metadata", async () => {
  ...
  assert.equal(project.version.current, "0.7.0");
  assert.equal(portable.version, "0.7.0");
  assert.equal(claude.version, "0.7.0");
  assert.match(codex.version, /^0\.7\.0\+codex\.\d{14}$/);
});
