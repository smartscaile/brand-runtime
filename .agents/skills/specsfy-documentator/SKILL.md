...
3. Construir toda a documentação e `.specsfy/PACKAGES.md`, mesmo quando a
   ...
   ```bash
   node .agents/skills/specsfy-documentator/scripts/build_documentation.mjs --project <raiz>
   ```
...
5. Executar `--check` para provar que a documentação representa o estado atual:
   ...
   ```bash
   node .agents/skills/specsfy-documentator/scripts/build_documentation.mjs --project <raiz> --check
   ```
