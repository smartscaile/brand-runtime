...
A origem congelada, licença, blobs e a matriz de adoção ficam em `../../brand/references/design-method-provenance.md`. O método operativo pertence a `../../brand/references/design-foundation.md` e vale para todas as superfícies. Presentation especializa sua aplicação em slides sem duplicar a autoridade comum. Os gates de três slides, contrato v1, exportação e aprovação humana deste documento permanecem específicos da apresentação.